...
class LifestyleCollectionView:UIView, UICollectionViewDataSource, UICollectionViewDelegate {
   
    
    let categories: Array<String> = [
        "Travel Tips","Luxury Homes","Architecture","Interior Design","Fashion","Men's Style","Cars","Wine & Drinks","Home Products","Kitchen Products"
    ]
...
extension LifestyleCollectionView {//, UICollectionViewDataSource {
