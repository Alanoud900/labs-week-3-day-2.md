...
class MostPopularCollectionView:UIView, UICollectionViewDataSource, UICollectionViewDelegate {
...
extension MostPopularCollectionView {//, UICollectionViewDataSource {
